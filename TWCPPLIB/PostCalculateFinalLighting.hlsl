...
Texture2D<float4> rt_direct : register(t4);
Texture2D<float4> rt_direct_albedo : register(t5);
Texture2D<float4> rt_indirect : register(t6);
Texture2D<float4> rt_indirect_albedo : register(t7);
