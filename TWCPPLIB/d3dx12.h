...
struct CD3DX12_VIEWPORT : public D3D12_VIEWPORT {
    ...
    explicit CD3DX12_VIEWPORT(
        ...
        case D3D12_RESOURCE_DIMENSION_TEXTURE1D:
            TopLeftX = topLeftX;
            TopLeftY = 0.0f;
            Width = (SubresourceWidth != 0u ? SubresourceWidth : 1.0f) - topLeftX;
            Height = 1.0f;
            break;
        ...
        case D3D12_RESOURCE_DIMENSION_TEXTURE3D:
            ...
            TopLeftY = topLeftY;
            Width = (SubresourceWidth != 0u ? SubresourceWidth : 1.0f) - topLeftX;
            Height = (SubresourceHeight != 0u ? SubresourceHeight : 1.0f) - topLeftY;
            break;
        default:
            break;
        }
...
struct CD3DX12_DEPTH_STENCIL_DESC : public D3D12_DEPTH_STENCIL_DESC {
    ...
    explicit CD3DX12_DEPTH_STENCIL_DESC(CD3DX12_DEFAULT /*unused*/) {
        DepthEnable = TRUE;
...
struct CD3DX12_DEPTH_STENCIL_DESC1 : public D3D12_DEPTH_STENCIL_DESC1 {
    ...
    explicit CD3DX12_DEPTH_STENCIL_DESC1(CD3DX12_DEFAULT /*unused*/) {
        DepthEnable = TRUE;
        DepthWriteMask = D3D12_DEPTH_WRITE_MASK_ALL;
        DepthFunc = D3D12_COMPARISON_FUNC_LESS;
        StencilEnable = FALSE;
...
struct CD3DX12_BLEND_DESC : public D3D12_BLEND_DESC {
    ...
    explicit CD3DX12_BLEND_DESC(const D3D12_BLEND_DESC& o)
        : D3D12_BLEND_DESC(o) {}
    explicit CD3DX12_BLEND_DESC(CD3DX12_DEFAULT /*unused*/) {
...
struct CD3DX12_RASTERIZER_DESC : public D3D12_RASTERIZER_DESC {
    ...
    explicit CD3DX12_RASTERIZER_DESC(CD3DX12_DEFAULT /*unused*/) {
...
struct CD3DX12_ROOT_SIGNATURE_DESC : public D3D12_ROOT_SIGNATURE_DESC {
    ...
    CD3DX12_ROOT_SIGNATURE_DESC(CD3DX12_DEFAULT /*unused*/) {
...
struct CD3DX12_VERSIONED_ROOT_SIGNATURE_DESC : public D3D12_VERSIONED_ROOT_SIGNATURE_DESC {
    ...
    CD3DX12_VERSIONED_ROOT_SIGNATURE_DESC(CD3DX12_DEFAULT /*unused*/) {
...
struct CD3DX12_CPU_DESCRIPTOR_HANDLE : public D3D12_CPU_DESCRIPTOR_HANDLE {
    ...
    CD3DX12_CPU_DESCRIPTOR_HANDLE(CD3DX12_DEFAULT /*unused*/) { ptr = 0; }
...
struct CD3DX12_GPU_DESCRIPTOR_HANDLE : public D3D12_GPU_DESCRIPTOR_HANDLE {
    ...
    CD3DX12_GPU_DESCRIPTOR_HANDLE(CD3DX12_DEFAULT /*unused*/) { ptr = 0; }
...
struct CD3DX12_VIEW_INSTANCING_DESC : public D3D12_VIEW_INSTANCING_DESC {
    ...
    explicit CD3DX12_VIEW_INSTANCING_DESC(CD3DX12_DEFAULT /*unused*/) {
        ViewInstanceCount = 0;
...
//------------------------------------------------------------------------------------------------
inline bool D3D12IsLayoutOpaque(D3D12_TEXTURE_LAYOUT Layout) { return Layout == D3D12_TEXTURE_LAYOUT_UNKNOWN || Layout == D3D12_TEXTURE_LAYOUT_64KB_UNDEFINED_SWIZZLE; }
...
struct ID3DX12PipelineParserCallbacks {
    // Subobject Callbacks
    virtual void FlagsCb(D3D12_PIPELINE_STATE_FLAGS /*unused*/) {}
    virtual void NodeMaskCb(UINT /*unused*/) {}
    virtual void RootSignatureCb(ID3D12RootSignature* /*unused*/) {}
    virtual void InputLayoutCb(const D3D12_INPUT_LAYOUT_DESC& /*unused*/) {}
    virtual void IBStripCutValueCb(D3D12_INDEX_BUFFER_STRIP_CUT_VALUE /*unused*/) {}
    virtual void PrimitiveTopologyTypeCb(D3D12_PRIMITIVE_TOPOLOGY_TYPE /*unused*/) {}
    virtual void VSCb(const D3D12_SHADER_BYTECODE& /*unused*/) {}
    virtual void GSCb(const D3D12_SHADER_BYTECODE& /*unused*/) {}
    virtual void StreamOutputCb(const D3D12_STREAM_OUTPUT_DESC& /*unused*/) {}
    virtual void HSCb(const D3D12_SHADER_BYTECODE& /*unused*/) {}
    virtual void DSCb(const D3D12_SHADER_BYTECODE& /*unused*/) {}
    virtual void PSCb(const D3D12_SHADER_BYTECODE& /*unused*/) {}
    virtual void CSCb(const D3D12_SHADER_BYTECODE& /*unused*/) {}
    virtual void BlendStateCb(const D3D12_BLEND_DESC& /*unused*/) {}
    virtual void DepthStencilStateCb(const D3D12_DEPTH_STENCIL_DESC& /*unused*/) {}
    virtual void DepthStencilState1Cb(const D3D12_DEPTH_STENCIL_DESC1& /*unused*/) {}
    virtual void DSVFormatCb(DXGI_FORMAT /*unused*/) {}
    virtual void RasterizerStateCb(const D3D12_RASTERIZER_DESC& /*unused*/) {}
    virtual void RTVFormatsCb(const D3D12_RT_FORMAT_ARRAY& /*unused*/) {}
    virtual void SampleDescCb(const DXGI_SAMPLE_DESC& /*unused*/) {}
    virtual void SampleMaskCb(UINT /*unused*/) {}
    virtual void ViewInstancingCb(const D3D12_VIEW_INSTANCING_DESC& /*unused*/) {}
    virtual void CachedPSOCb(const D3D12_CACHED_PIPELINE_STATE& /*unused*/) {}
...
struct CD3DX12_PIPELINE_STATE_STREAM1 {
    ...
    CD3DX12_PIPELINE_STATE_STREAM1(const D3D12_COMPUTE_PIPELINE_STATE_DESC& Desc)
        ...
        , CachedPSO(Desc.CachedPSO) {
        static_cast<D3D12_DEPTH_STENCIL_DESC1&>(DepthStencilState).DepthEnable = 0;
    }
...
struct CD3DX12_PIPELINE_STATE_STREAM_PARSE_HELPER : public ID3DX12PipelineParserCallbacks {
    ...
    noexcept
        ...
        static_cast<D3D12_DEPTH_STENCIL_DESC1&>(PipelineStream.DepthStencilState).DepthEnable = 0;
    }
    ...
    void DSVFormatCb(DXGI_FORMAT DSVFormat) override {
        ...
        if (!SeenDSS && DSVFormat != DXGI_FORMAT_UNKNOWN) {
            ...
            static_cast<D3D12_DEPTH_STENCIL_DESC1&>(PipelineStream.DepthStencilState).DepthEnable = 1;
        }
    }
...
public:
    ...
    operator const D3D12_STATE_OBJECT_DESC&() {
        ...
        m_Desc.pSubobjects = m_Desc.NumSubobjects != 0u ? &m_SubobjectArray[0] : nullptr;
        return m_Desc;
    }
    operator const D3D12_STATE_OBJECT_DESC*() {
...
public:
    ...
    void SetDXILLibrary(D3D12_SHADER_BYTECODE* pCode) {
        ...
        m_Desc.DXILLibrary = pCode != nullptr ? *pCode : Default;
    }
    void DefineExport(
        LPCWSTR Name,
