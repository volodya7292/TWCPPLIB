...
TW3D::TW3DTempGCL::TW3DTempGCL(TW3DDevice* Device) {
	...
	CommandList = new TW3DGraphicsCommandList(Device, D3D12_COMMAND_LIST_TYPE_DIRECT, CommandAllocator);
	CommandList->Close();
}
...
void TW3D::TW3DTempGCL::ResourceBarrier(TW3DResource* Resource, D3D12_RESOURCE_STATES StateBefore, D3D12_RESOURCE_STATES StateAfter) {
