...
void TW3D::TW3DGraphicsCommandList::SetRenderTarget(const D3D12_CPU_DESCRIPTOR_HANDLE* RTVDescriptor, const D3D12_CPU_DESCRIPTOR_HANDLE* DSVDescriptor) {
	commandList->OMSetRenderTargets(1, RTVDescriptor, false, DSVDescriptor);
}

void TW3D::TW3DGraphicsCommandList::SetRenderTargets(TWT::UInt RTVDescriptorCount, const D3D12_CPU_DESCRIPTOR_HANDLE* RTVDescriptors, const D3D12_CPU_DESCRIPTOR_HANDLE* DSVDescriptor) {
	commandList->OMSetRenderTargets(RTVDescriptorCount, RTVDescriptors, false, DSVDescriptor);
}
...
void TW3D::TW3DGraphicsCommandList::ClearDSVDepth(D3D12_CPU_DESCRIPTOR_HANDLE DSVDescriptor, TWT::Float Depth) {
	commandList->ClearDepthStencilView(DSVDescriptor, D3D12_CLEAR_FLAG_DEPTH, Depth, 0, 0, nullptr);
}
