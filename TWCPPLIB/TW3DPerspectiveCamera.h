...
public:
	TW3DPerspectiveCamera(TW3DResourceManager* ResourceManager = nullptr, TWT::uint Width = 1280, TWT::uint Height = 720, float FOVY = 70.0f, TWT::float3 Position = TWT::float3(0),
